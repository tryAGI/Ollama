...
{
    /// <inheritdoc />
    public class ThinkValueJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Ollama.ThinkValue>
    {
        /// <inheritdoc />
        public override global::Ollama.ThinkValue Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            bool? thinkValueVariant1 = default;
            string? thinkValueVariant2 = default;
            object? thinkValueVariant3 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        ...
                        thinkValueVariant1 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        ...
                        thinkValueVariant2 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
                ...
                else if (__bestIndex == 2)
                {
                    try
                    {
                        ...
                        thinkValueVariant3 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            if (thinkValueVariant1 == null && thinkValueVariant2 == null && thinkValueVariant3 == null)
            {
                try
                {
            ...
            var __value = new global::Ollama.ThinkValue(
                thinkValueVariant1,
        ...
        public override void Write(
            ...
            global::Ollama.ThinkValue value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");

            if (value.IsThinkValueVariant1)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(bool), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<bool> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(bool).Name}");
