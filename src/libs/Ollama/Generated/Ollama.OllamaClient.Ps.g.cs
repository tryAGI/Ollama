...
namespace Ollama
{
    ...
    {
        partial void PreparePsArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PreparePsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessPsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await PsAsResponseAsync(
        ...
        /// curl http://localhost:11434/api/ps
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Ollama.AutoSDKHttpResponse<global::Ollama.PsResponse>> PsAsResponseAsync(
            global::Ollama.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                    ...
                    await global::Ollama.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Ollama.PsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Ollama.AutoSDKHttpResponse<global::Ollama.PsResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Ollama.PsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
