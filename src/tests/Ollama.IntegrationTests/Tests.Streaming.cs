...
public partial class Tests
{
    ...
    public async Task Returns_Streamed_Responses_At_Once()
    {
        ...
        var context = await client.GenerateCompletionAsync(string.Empty, "prompt").WaitAsync();
    ...
    public async Task Streams_Response_Chunks()
    {
        ...
        var enumerable = client.GenerateCompletionAsync("llama3", "prompt");
    ...
    public async Task Streams_Response_Message_Chunks()
    {
        ...
        var response = await client.GenerateChatCompletionAsync(chat).WaitAsync();
    ...
    public async Task Returns_Deserialized_Models1()
    {
        ...
        var info = await client.ShowModelInfoAsync("codellama:latest", CancellationToken.None);
    ...
    public async Task Returns_Deserialized_Models2()
    {
        ...
        var info = await client.GenerateEmbeddingAsync(
            model: "",
            prompt: "",
