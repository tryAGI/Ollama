...
public partial class Tests
{
    ...
    public async Task Returns_Streamed_Responses_At_Once()
    {
        ...
        var context = await client.Completions.GenerateCompletionAsync(string.Empty, "prompt").WaitAsync();
    ...
    public async Task Streams_Response_Chunks()
    {
        ...
        var enumerable = client.Completions.GenerateCompletionAsync("llama3", "prompt");
    ...
    public async Task Streams_Response_Message_Chunks()
    {
        ...
        var response = await client.Chat.GenerateChatCompletionAsync(chat).WaitAsync();
    ...
    public async Task Returns_Deserialized_Models()
    {
        ...
        var models = await client.Models.ListModelsAsync(CancellationToken.None);
    ...
    public async Task Returns_Deserialized_Models1()
    {
        ...
        var info = await client.Models.ShowModelInfoAsync("codellama:latest", CancellationToken.None);
    ...
    public async Task Returns_Deserialized_Models2()
    {
        ...
        var info = await client.Embeddings.GenerateEmbeddingAsync(
            model: "",
            prompt: "",
